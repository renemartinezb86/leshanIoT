...
import client.SmartObjects.Generic_DHTXX;
import client.SmartObjects.Humidity_DHTXX;
  ...
  //  private static final int OBJECT_ID_FUELLEVEL = 4300;
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort,
     ...
     //   initializer.setInstancesForObject(2125,  new RandomTemperatureSensor());
        ...
        ParticleConcentration pc1 = new ParticleConcentration(50, 234, "CO2");
        ParticleConcentration pc2 = new ParticleConcentration(60, 234, "O2");
        ParticleConcentration pc3 = new ParticleConcentration(70, 234, "M2");
